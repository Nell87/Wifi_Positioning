...
## D. CONCLUSIONS ##
We were able to determine a person's location with a certain margin of error (as we saw in the previous analysis). Let's check in which areas we have the large amount of errors. 
